...
export const mockUsers: User[] = [
  ...
  // Production Staff with specific roles
  {
    id: 'user_3',
    email: 'olena.petrenko@fashionflow.com',
    name: 'Олена Петренко',
    role: 'designer',
    ...
    position: 'Дизайнер',
    department: 'Design',
    specialties: ['Дизайн одягу', 'Кольорознавство'],
    createdAt: new Date('2024-01-15'),
  },
  {
    id: 'user_4',
    email: 'victor.kovalenko@fashionflow.com',
    name: 'Віктор Коваленко',
    role: 'pattern_maker',
    productionRole: 'pattern_maker',
    companyId: 'comp_1',
    phone: '+380 50 444 4444',
    position: 'Конструктор',
    department: 'Pattern Making',
    specialties: ['Побудова викрійок', 'Градація'],
    createdAt: new Date('2024-02-01'),
  },
  {
    id: 'user_5',
    email: 'natasha.shevchenko@fashionflow.com',
    name: 'Наталія Шевченко',
    role: 'technologist',
    productionRole: 'technologist',
    companyId: 'comp_1',
    phone: '+380 50 555 5555',
    position: 'Технолог',
    department: 'Technology',
    specialties: ['Розробка технологічних карт', 'ВТО'],
    createdAt: new Date('2024-02-10'),
  },
  {
    id: 'user_6',
    email: 'ivan.bondarenko@fashionflow.com',
    name: 'Іван Бондаренко',
    role: 'cutter',
    productionRole: 'cutter',
    companyId: 'comp_1',
    phone: '+380 50 666 6666',
    position: 'Розкрійник',
    department: 'Cutting',
    specialties: ['Крій тканин', 'Розкладка'],
    createdAt: new Date('2024-03-01'),
  },
  {
    id: 'user_7',
    email: 'anna.kozak@fashionflow.com',
    name: 'Анна Козак',
    role: 'seamstress',
    productionRole: 'seamstress',
    companyId: 'comp_1',
    phone: '+380 50 777 7777',
    position: 'Швачка',
    department: 'Sewing',
    specialties: ['Пошив жіночого одягу', 'Вишивка'],
    createdAt: new Date('2024-03-15'),
  },
  {
    id: 'user_8',
    email: 'petro.vasylenko@fashionflow.com',
    name: 'Петро Василенко',
    role: 'seamstress',
    productionRole: 'seamstress',
    companyId: 'comp_1',
    phone: '+380 50 888 8888',
    position: 'Швачка',
    department: 'Sewing',
    specialties: ['Пошив чоловічого одягу'],
    createdAt: new Date('2024-04-01'),
  },
  {
    id: 'user_9',
    email: 'olha.mykhailova@fashionflow.com',
    name: 'Ольга Михайлова',
    role: 'finisher',
    productionRole: 'finisher',
    companyId: 'comp_1',
    phone: '+380 50 999 9999',
    position: 'Закрійник',
    department: 'Finishing',
    specialties: ['ВТО', 'Прасування'],
    createdAt: new Date('2024-04-15'),
  },
  {
    id: 'user_10',
    email: 'dmytro.hrynko@fashionflow.com',
    name: 'Дмитро Гринко',
    role: 'qc_inspector',
    productionRole: 'qc_inspector',
    companyId: 'comp_1',
    phone: '+380 50 101 0101',
    position: 'Контролер якості',
    department: 'Quality Control',
    specialties: ['Перевірка якості', 'Дефектація'],
    createdAt: new Date('2024-05-01'),
  },
  {
    id: 'user_11',
    email: 'svitlana.romanova@fashionflow.com',
    name: 'Світлана Романова',
    role: 'packer',
    productionRole: 'packer',
    companyId: 'comp_1',
    phone: '+380 50 111 1212',
    position: 'Пакувальник',
...
// Size Tables
export const mockSizeTables: SizeTable[] = [
  {
    id: 'size_1',
    name: 'Жіночі сукні (універсальна)',
    description: 'Стандартна розмірна сітка для жіночих суконь',
    baseSize: 'M',
    gradations: [
      { size: 'XS', code: '42', chestCircumference: 84, waistCircumference: 64, hipsCircumference: 88, backLength: 40, quantity: 0 },
      { size: 'S', code: '44', chestCircumference: 88, waistCircumference: 68, hipsCircumference: 92, backLength: 41, quantity: 0 },
      { size: 'M', code: '46', chestCircumference: 92, waistCircumference: 72, hipsCircumference: 96, backLength: 42, quantity: 0 },
      { size: 'L', code: '48', chestCircumference: 96, waistCircumference: 76, hipsCircumference: 100, backLength: 43, quantity: 0 },
      { size: 'XL', code: '50', chestCircumference: 100, waistCircumference: 80, hipsCircumference: 104, backLength: 44, quantity: 0 },
      { size: 'XXL', code: '52', chestCircumference: 104, waistCircumference: 84, hipsCircumference: 108, backLength: 45, quantity: 0 },
    ],
    createdAt: new Date('2024-01-01'),
  },
  {
    ...
    description: 'Розмірна сітка для чоловічих сорочок',
    baseSize: 'M',
    gradations: [
      { size: 'S', code: '37', chestCircumference: 92, waistCircumference: 86, backLength: 74, sleeveLength: 60, shoulderWidth: 46, quantity: 0 },
      { size: 'M', code: '39', chestCircumference: 96, waistCircumference: 90, backLength: 76, sleeveLength: 62, shoulderWidth: 48, quantity: 0 },
      { size: 'L', code: '41', chestCircumference: 100, waistCircumference: 94, backLength: 78, sleeveLength: 64, shoulderWidth: 50, quantity: 0 },
      { size: 'XL', code: '43', chestCircumference: 104, waistCircumference: 98, backLength: 80, sleeveLength: 66, shoulderWidth: 52, quantity: 0 },
      { size: 'XXL', code: '45', chestCircumference: 108, waistCircumference: 102, backLength: 82, sleeveLength: 68, shoulderWidth: 54, quantity: 0 },
    ],
    createdAt: new Date('2024-01-01'),
  },
];
...
// Garment Models
export const mockGarmentModels: GarmentModel[] = [
  {
    id: 'model_1',
    name: 'Сукня вечірня "Рококо"',
    sku: 'GM-DR-001',
    description: 'Елегантна вечірня сукня з пишною спідницею',
    type: 'serial',
    previewUrl: 'https://picsum.photos/seed/dress1/400/600',
    technicalDrawingUrl: '',
    sizeTableId: 'size_1',
    processTemplateId: 'proc_1',
    basePrice: 2500,
    materials: ['mat_1', 'mat_3'],
    createdAt: new Date('2024-01-15'),
    updatedAt: new Date('2024-03-01'),
  },
  {
    id: 'model_2',
    name: 'Костюм чоловічий "Оксфорд"',
    sku: 'GM-SU-001',
    description: 'Класичний чоловічий костюм для офісу',
    type: 'serial',
    previewUrl: 'https://picsum.photos/seed/suit1/400/600',
    sizeTableId: 'size_2',
    processTemplateId: 'proc_2',
    basePrice: 4500,
    materials: ['mat_2'],
    createdAt: new Date('2024-02-01'),
  ...
  {
    id: 'model_3',
    name: 'Вишивана сорочка (індивідуальна)',
    sku: 'GM-SH-001',
    description: 'Традиційна вишивана сорочка на замовлення',
    type: 'individual',
    previewUrl: 'https://picsum.photos/seed/shirt1/400/600',
    basePrice: 1800,
    materials: ['mat_2'],
    createdAt: new Date('2024-02-20'),
...
export const mockProcessTemplates: ProductionProcessTemplate[] = [
  {
    id: 'proc_1',
    name: 'Процес пошиву сукні (серійний)',
    description: 'Стандартний процес для серійного пошиву суконь',
    type: 'serial',
    operations: [
      { id: 'p_op_1', type: 'design', name: 'Дизайн', description: 'Розробка дизайну моделі', status: 'planned', role: 'designer', estimatedDuration: 120 },
      { id: 'p_op_2', type: 'pattern', name: 'Побудова викрійки', description: 'Побудова базової викрійки та градація', status: 'planned', role: 'pattern_maker', estimatedDuration: 180 },
      { id: 'p_op_3', type: 'tech_process', name: 'Розробка технології', description: 'Розробка технологічної карти', status: 'planned', role: 'technologist', estimatedDuration: 60 },
      { id: 'p_op_4', type: 'cutting', name: 'Крій', description: 'Розкрій деталей крою', status: 'planned', role: 'cutter', estimatedDuration: 90 },
      { id: 'p_op_5', type: 'sewing', name: 'Пошив', description: 'Збірка та пошив виробу', status: 'planned', role: 'seamstress', estimatedDuration: 240 },
      { id: 'p_op_6', type: 'finishing', name: 'ВТО', description: 'Волого-теплова обробка', status: 'planned', role: 'finisher', estimatedDuration: 30 },
      { id: 'p_op_7', type: 'quality_control', name: 'Контроль якості', description: 'Перевірка якості виробу', status: 'planned', role: 'qc_inspector', estimatedDuration: 20 },
      { id: 'p_op_8', type: 'packaging', name: 'Пакування', description: 'Пакування готового виробу', status: 'planned', role: 'packer', estimatedDuration: 15 },
    ],
    estimatedTime: 755,
    createdAt: new Date('2024-01-01'),
  },
  {
    id: 'proc_2',
    name: 'Процес індивідуального пошиву',
    description: 'Процес для індивідуального пошиву з примірками',
    type: 'individual',
    operations: [
      { id: 'i_op_1', type: 'design', name: 'Консультація', description: 'Зустріч з клієнтом, обговорення побажань', status: 'planned', role: 'designer', estimatedDuration: 60 },
      { id: 'i_op_2', type: 'pattern', name: 'Зняття мірок', description: 'Зняття індивідуальних мірок', status: 'planned', role: 'pattern_maker', estimatedDuration: 30 },
      { id: 'i_op_3', type: 'pattern', name: 'Побудова викрійки', description: 'Побудова індивідуальної викрійки', status: 'planned', role: 'pattern_maker', estimatedDuration: 120 },
      { id: 'i_op_4', type: 'tech_process', name: 'Розробка технології', description: 'Розробка технологічної карти', status: 'planned', role: 'technologist', estimatedDuration: 45 },
      { id: 'i_op_5', type: 'cutting', name: 'Крій', description: 'Крій деталей за індивідуальними мірками', status: 'planned', role: 'cutter', estimatedDuration: 60 },
      { id: 'i_op_6', type: 'sewing', name: 'Пошив', description: 'Пошив виробу', status: 'planned', role: 'seamstress', estimatedDuration: 180 },
      { id: 'i_op_7', type: 'fitting', name: 'Примірка 1', description: 'Перша примірка - перевірка посадки', status: 'planned', role: 'seamstress', estimatedDuration: 30 },
      { id: 'i_op_8', type: 'sewing', name: 'Корекція', description: 'Виправлення за результатами примірки', status: 'planned', role: 'seamstress', estimatedDuration: 60 },
      { id: 'i_op_9', type: 'fitting', name: 'Примірка 2', description: 'Друга примірка', status: 'planned', role: 'seamstress', estimatedDuration: 30 },
      { id: 'i_op_10', type: 'sewing', name: 'Фінальна корекція', description: 'Остаточні виправлення', status: 'planned', role: 'seamstress', estimatedDuration: 45 },
      { id: 'i_op_11', type: 'fitting', name: 'Примірка 3', description: 'Третя примірка (за потреби)', status: 'planned', role: 'seamstress', estimatedDuration: 30 },
      { id: 'i_op_12', type: 'finishing', name: 'ВТО', description: 'Волого-теплова обробка', status: 'planned', role: 'finisher', estimatedDuration: 30 },
      { id: 'i_op_13', type: 'quality_control', name: 'Контроль якості', description: 'Перевірка якості', status: 'planned', role: 'qc_inspector', estimatedDuration: 20 },
      { id: 'i_op_14', type: 'packaging', name: 'Пакування', description: 'Пакування готового виробу', status: 'planned', role: 'packer', estimatedDuration: 15 },
    ],
    estimatedTime: 755,
    createdAt: new Date('2024-01-01'),
  },
...
// Fitting Stages for Individual Orders
export const mockFittingStages: FittingStage[] = [
  {
    id: 'fit_1',
    orderId: 'order_3',
    productionOrderId: 'prod_order_5',
    stageNumber: 1,
    name: 'Примірка 1',
    description: 'Перевірка посадки по основних деталях',
    scheduledDate: new Date('2024-04-10'),
    status: 'completed',
    approved: true,
    notes: 'Посадка хороша, потрібно трохи звузити в талії',
  },
  {
    id: 'fit_2',
    orderId: 'order_3',
    ...
    stageNumber: 2,
    name: 'Примірка 2',
    description: 'Перевірка після корекції',
    scheduledDate: new Date('2024-04-12'),
    actualDate: new Date('2024-04-12'),
    status: 'completed',
    approved: true,
    notes: 'Все добре, затверджено',
  },
  {
    id: 'fit_3',
    orderId: 'order_3',
    productionOrderId: 'prod_order_5',
    stageNumber: 3,
    name: 'Фінальна примірка',
    description: 'Остаточна перевірка готового виробу',
...
// Role Labels
export const productionRoleLabels: Record<ProductionRole, string> = {
  designer: 'Дизайнер',
  pattern_maker: 'Конструктор',
  technologist: 'Технолог',
  cutter: 'Розкрійник',
  seamstress: 'Швачка',
  finisher: 'Закрійник',
  qc_inspector: 'Контролер якості',
  packer: 'Пакувальник',
};
